...
<template>
  <div>
    ...
    <el-dialog
      title="提示"
      :visible.sync="diaog123"
      width="30%"
      :before-close="handleClose"
    >
    <div><el-form :model="aform" label-width="80px">
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button @click="diaog123 = false">取 消</el-button>
        <el-button type="primary" @click="diaog123 = false">确 定</el-button>
      </span>
    </el-dialog>
  </div>
</template>
