      ...
      <div style="width: 80%; margin: auto" class="dialog_body">
        ...
        <el-form-item label="项目名称" prop="proj_name">
          ...
          <!-- <el-form-item label="批复金额" prop="cred_lim">
            <el-input
              v-model="addfrom.cred_lim"
              placeholder="请输入"
            ></el-input>
          </el-form-item>
          <el-form-item label="授信种类" prop="cred_lim">
            <el-input
              v-model="addfrom.cred_lim"
              placeholder="请输入"
            ></el-input>
          ...
          <el-form-item label="融资费用" prop="cred_lim">
            <el-input
              v-model="addfrom.cred_lim"
              placeholder="请输入"
            ></el-input>
          </el-form-item>
          <el-form-item label="第一担保" prop="cred_lim">
            <el-input
              v-model="addfrom.cred_lim"
              placeholder="请输入"
            ></el-input>
          </el-form-item>
          <el-form-item label="担保金额" prop="cred_lim">
            <el-input
              v-model="addfrom.cred_lim"
              placeholder="请输入"
            ></el-input>
          </el-form-item>
          <el-form-item label="担保费率" prop="cred_lim">
            <el-input
              v-model="addfrom.cred_lim"
              placeholder="请输入"
            ></el-input>
          </el-form-item>
          <el-form-item label="担保方式" prop="cred_lim">
            <el-input
              v-model="addfrom.cred_lim"
              placeholder="请输入"
            ></el-input>
          </el-form-item>
          <el-form-item label="担保信息" prop="cred_lim">
            <el-input
              v-model="addfrom.cred_lim"
              placeholder="请输入"
            ></el-input>
...
export default {
  ...
  methods: {
    ...
    async deleteBtn() {
      this.$confirm("此操作将永久删除所选项目(包括下级绑定的信息), 是否继续?", "提示", {
