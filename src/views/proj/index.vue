  ...
  <div class="content-wrap">
    <el-card style="margin: 0 auto">
      <div class="custom-btn-wrap">
        <div class="add-custom-btn" @click="dialogVisible = true">
          <i class="el-icon-plus"></i>新增项目
        </div>
        <!-- <div class="add-custom-btn" @click="nextProj">
          <i class="el-icon-plus"></i>模拟项目
        </div> -->
        <div class="delete-custom-btn" @click="delProj">
    ...
    >
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button
          ...
          >上一步</el-button
        >
        <el-button type="primary" v-show="dialogShow === 1" @click="projNext"
          >下一步</el-button
        >
...
export default {
  ...
  methods: {
    ...
    //edit按钮
    edit_btn(row) {
      if (row.proj_node !== "end") {
        // return this.$message({
        //   type:'error',
        //   message:'项目信息未录入完整'
        // })

        this.$confirm("该项目尚未录入完整，点击确定继续录入", "提示", {
    ...
    delProj() {
      ...
      this.$confirm(
        "此操作将永久删除被选择项目以及项目所有子信息（删除后不可恢复）, 是否继续?",
        "警告",
        {
          confirmButtonText: "确定",
          cancelButtonText: "取消",
