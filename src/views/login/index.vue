<template>
  <div class="login-container">
    <!-- <div >
      <img style="margin: 20px 40px;" src="http://www.gz-srt.com/srt/img/logo.png" alt="">
    </div> -->
...
.login-container {
  ...
  width: 100%;
  background-color: $bg;
  background: url('https://ty-test.xyz/li/1635583f5d1c4d517aba88a142057607a8683695.jpg');
