...
/* ******************************自定义表格样式*********************************** */
  ...
  /* 删除按钮 */
  .delete-custom-table-btn{
    cursor: pointer;
    color: red;
    border-radius: 3px;
  }
  /* 保存按钮 */
  .save-custom-table-btn{
    color: #409eff;
    border-radius: 3px;
    margin-right: 16px;
    cursor: pointer;
  ...
  .cancel-custom-dialog-btn:hover{
